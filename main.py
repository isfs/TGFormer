...
# from models.TGS import TGFormer
from models.modules import MergeLayer
# from models.DyGFormer import DyGFormer
# from models.TGFormer import DyGFormer
from models.TGFormer import TGFormer
...
def main(args):
    ...
    for run in range(args.num_runs):
        ...
        # create model
        dynamic_backbone = TGFormer(node_raw_features=node_raw_features, edge_raw_features=edge_raw_features, neighbor_sampler=train_neighbor_sampler,
                                         time_feat_dim=args.time_feat_dim, channel_embedding_dim=args.channel_embedding_dim, patch_size=args.patch_size,
                                         num_layers=args.num_layers, num_heads=args.num_heads, dropout=args.dropout,
                                         max_input_sequence_length=args.num_neighbors, device=args.device, version=args.model_name)
